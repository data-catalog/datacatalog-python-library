...
conf = data_catalog.client.user.Configuration(
    ...
    def __init__(self, host="https://userhandlingservice.azurewebsites.net",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("data_catalog.client.user")
