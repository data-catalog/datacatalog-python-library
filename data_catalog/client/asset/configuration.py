...
conf = data_catalog.client.asset.Configuration(
    ...
    def __init__(self, host="https://assethandlingservice.azurewebsites.net",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("data_catalog.client.asset")
