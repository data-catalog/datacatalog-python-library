...
import data_catalog.client.versioning.models
from data_catalog.client.versioning import rest
from data_catalog.client.versioning.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(data_catalog.client.versioning.models, klass)
